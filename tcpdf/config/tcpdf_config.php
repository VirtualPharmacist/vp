 ...
 */
define ('K_BLANK_IMAGE', 'image_with_alpha.png');
 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'VP');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'VP');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'VP: Virtual Pharmacist');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "VP established researrch report\nUser account:");
