  ...
  container: document.getElementById('cy'),
	  ...
	  ready: function(){
		// ready 1
  		window.cy = this;
		cy.layout( options );
		var edgesFromJerry1 = cy.elements('node[type="system"]');		
		edgesFromJerry1.css('background-color', '#FFDD00');	
		var edgesFromJerry2 = cy.elements('node[type="gene"]');		
		edgesFromJerry2.css('background-color', '#8EE834');	
		var edgesFromJerry3 = cy.elements('node[type="drug"]');
		edgesFromJerry3.css('background-color', '#23CFE2');	
