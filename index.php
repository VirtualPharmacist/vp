...
<?php include('multiple.php') ?>
 <p class="LingJiCaiDan">Variants data analysis (VCF format)
</p>

<div class="post1">
<form  action="upload_jump_vcf.php" method="get" enctype="multipart/form-data" >
...
<br />
      Please upload your variants data file in <font color="#FF0000">*.zip</font> format:
            <a target="Help" href="user_guide.php#q2.1.1"><img border="0" alt="?" src="images/help.png"></a>
        </font>

    <font size="-1">(<a href="download3.php" target="_blank">sample.vcf.zip</a> for download)</font>
    <br />
   <br>
...
(<a href="download2.php?code=example&file=1">Click here to find an example of output</a>)	
	<br><br>
 <p id="asd">This program may take up to 2 minutes to process your data</p>   
  ...
  <p class="LingJiCaiDan1">Microarray data analysis</p>
...
<font size="3">FTP account<font color="#FF0000" size="+3">*&nbsp;&nbsp;</font></font>
        <input type="text" value="test" maxlength="50" size="30" name="account" id="account"> 
        <font size="-1">(Provide your FTP account to find your data in our server)</font><br>
        <input type="button" id="button1" onclick="tijiao1()" value="&nbsp;&nbsp;&nbsp;Browse&nbsp;&nbsp;&nbsp;" name="Browse">  
<Br />
...
<script>
     ...
     $(".LingJiCaiDan1").click(function () {
      window.open("index_microarray.php","_self");		//this指的是(触发click事件	的)类或者id	//next就是紧挨着自己的下一个标签(在代码中就是ul标签)
    });	
